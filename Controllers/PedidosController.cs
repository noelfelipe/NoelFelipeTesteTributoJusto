...
using NoelFelipe.Data;
using NoelFelipe.Models;

namespace NoelFelipe.Controllers
{
    public class PedidosController : Controller
    {
        private NoelFelipeContext db = new NoelFelipeContext();
        ...
        public ActionResult Create([Bind(Include = "IdPedido,IdProduto,IdCliente")] Pedido pedido)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdPedido,IdProduto,IdCliente")] Pedido pedido)
        {
            if (ModelState.IsValid)
            {
